...
export const TransactionErrorNames = {
  // SoundEdition
...
export const TransactionErrorSigNames = {
  // SoundEdition
...
export type TransactionErrorName = typeof TransactionErrorSigNames[keyof typeof TransactionErrorSigNames]
