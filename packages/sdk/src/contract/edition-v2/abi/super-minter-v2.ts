export const SUPER_MINTER_V2_ADDRESS = '0x000000000001A36777f9930aAEFf623771b13e70'

export const SUPER_MINTER_V2_ABI = [
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'platform', type: 'address' },
      {
        components: [
          ...
          { internalType: 'uint16', name: 'platformMintFeeBPS', type: 'uint16' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint8', name: 'scheduleNum', type: 'uint8' },
      { internalType: 'uint32', name: 'quantity', type: 'uint32' },
      { internalType: 'bool', name: 'hasValidAffiliate', type: 'bool' },
    ],
